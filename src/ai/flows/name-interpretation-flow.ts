...
const InterpretNameOutputSchema = z.object({
  ...
  lifeStages: z.object({
    초년운: z.string().describe('초년운 (예: 0-25세)의 주요 특징과 핵심 조언을 요약하여 설명합니다. 긍정적 측면, 주의점, 대략적인 나이 구간을 포함해야 합니다.'),
    중년운: z.string().describe('중년운 (예: 26-50세)의 주요 특징과 핵심 조언을 요약하여 설명합니다. 긍정적 측면, 주의점, 대략적인 나이 구간을 포함해야 합니다.'),
    장년운: z.string().describe('장년운 (예: 51-75세)의 주요 특징과 핵심 조언을 요약하여 설명합니다. 긍정적 측면, 주의점, 대략적인 나이 구간을 포함해야 합니다.'),
    말년운: z.string().describe('말년운 (예: 76세 이후)의 주요 특징과 핵심 조언을 요약하여 설명합니다. 긍정적 측면, 주의점, 대략적인 나이 구간을 포함해야 합니다.'),
  }),
...
2.  **생애 주기별 운세 (lifeStages - 초년운, 중년운, 장년운, 말년운)**: 각 생애 주기별로 **주요 특징과 핵심 조언을 매우 간결하게 요약**하여 제공합니다. **각 시기별 대략적인 나이 구간(예: 초년운 (0-25세), 중년운 (26-50세), 장년운 (51-75세), 말년운 (76세 이후))을 명시**하고, 주요 기회와 성과뿐 아니라, 예상되는 어려움이나 도전 과제, 그리고 이를 극복하기 위한 전략도 함께 **핵심만** 제시해주세요.
    *   초년운: (예: 0-25세) 유년기부터 청년기까지의 학업, 건강, 대인관계 등 **주요 사항에 대한 핵심 분석 및 조언을 간결하게** 제공합니다.
    *   중년운: (예: 26-50세) 청장년기의 직업, 재물, 결혼, 자녀 등 **주요 사항에 대한 핵심 분석 및 조언을 간결하게** 제공합니다.
    *   장년운: (예: 51-75세) 중장년기 이후의 사회적 성취, 건강, 가정 등 **주요 사항에 대한 핵심 분석 및 조언을 간결하게** 제공합니다.
    *   말년운: (예: 76세 이후) 노년기의 삶, 건강, 정신적 안정 등 **주요 사항에 대한 핵심 분석 및 조언을 간결하게** 제공합니다.
