...
export default function YearlyFortunePage() {
  ...
  const [currentConvertingNameField, setCurrentConvertingNameField] = useState<FieldPath<YearlyFortuneFormValues> | null>(null);
  ...
  const openHanjaModal = (fieldName: FieldPath<YearlyFortuneFormValues>) => {
