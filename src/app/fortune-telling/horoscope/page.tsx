...
export default function HoroscopePage() {
  ...
  const [currentConvertingNameField, setCurrentConvertingNameField] = useState<FieldPath<HoroscopeFormValues> | null>(null);
  ...
  const openHanjaModal = (fieldName: FieldPath<HoroscopeFormValues>) => {
